...
const helpers = require("../../examples/localmediacontrols/src/helpers");
const screenShareHelpers = require("../../examples/screenshare/src/helpers");
...
const createScreenTrack = screenShareHelpers.createScreenTrack;
